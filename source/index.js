...
import { formatterRegistry } from "./formatters/index.js";
...
const applyOptions = (object, options = {}) => {
	...
	// Set formatter
	object[FORMATTER] = options.formatter
		? formatterRegistry.get(options.formatter)
		: formatterRegistry.getDefault();
};
...
const applyStyle = (self, string) => {
	...
	// Use the formatter to apply styles
	return self[FORMATTER].format(string, styler);
};

Object.defineProperties(createChalk.prototype, styles);

// Add formatter-related methods to the prototype
Object.defineProperties(createChalk.prototype, {
	setFormatter: {
		value(formatterName) {
			this[FORMATTER] = formatterRegistry.get(formatterName);
			return this;
		},
		enumerable: true,
	},
...
// Export formatter-related functionality
export { formatterRegistry } from "./formatters/index.js";
export {
	BaseFormatter,
	AnsiFormatter,
	HtmlFormatter,
